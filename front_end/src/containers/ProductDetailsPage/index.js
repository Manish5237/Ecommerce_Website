        ...
        <div className="flexRow">
          ...
          <div className="productDescContainer">
            <div className="productDescImgContainer">
              <img src={generatePictureurl(product.productDetails.productPictures[0].img)} alt={`${product.productDetails.productPictures[0].img}`} />
            </div>
        ...
        <div>
          ...
          <div className="productDetails">
            ...
            <div>
              ...
              <span className="ratingNumbersReviews">99,999 Ratings & 9,999 Reviews</span>
            </div>
